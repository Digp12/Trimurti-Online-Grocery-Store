...
public class HomeController {
	...
	public String products(Model m, @RequestParam(defaultValue = "") String category,
			@RequestParam(defaultValue = "0") Integer pageNo, @RequestParam(defaultValue = "12") Integer pageSize,
		...
		List<Product> products1 = page.getContent();
	...
	public String getProductsByCategory(@RequestParam String category, Model m,
			@RequestParam(defaultValue = "0") Integer pageNo, @RequestParam(defaultValue = "12") Integer pageSize,
			@RequestParam(defaultValue = "") String ch) {
